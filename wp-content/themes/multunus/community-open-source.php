<article class="community-open-source">
  <div class="container">
    ...
    <?php wp_reset_query(); ?>
    <?php $open_source_page_permalink = get_permalink( get_page_by_path( 'open-source' ) ); ?>

    <div class="row align-right">
      <a href="<?php echo $open_source_page_permalink ?>">See All</a>
