				...
				$content.= "<div class='evo-jumper'><span class='evo-jumper-btn'>".eventon_get_custom_language($this->evopt2, 'evcal_lang_jumpmonths','Jump Months')."</span>
					...
					foreach($__months as $m){
						...
						<div class='evo_j_years evo_j_dates' val='y'>
							<p class='legend'>Year: <a>".($focused_year-2)."</a><a>".($focused_year-1)."</a><a class='current'>".$focused_year."</a><a>".($focused_year+1)."</a><a>".($focused_year+2)."</a></p><div class='clear'></div>
						</div>
	...
	public function eventon_get_cal_sortbar($default_event_type='all', $default_event_type_2='all', $sortbar=true){
		...
		echo "
			...
			if(in_array('event_type_2', $filtering_options) && $default_event_type_2=='all'){
				echo "
				<div class='eventon_filter evo_sortOpt' filter_field='event_type_2' filter_val='all' filter_type='tax' >
